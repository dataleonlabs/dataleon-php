...
use Dataleon\Parameters\CompanyUpdateParam\Company;
use Dataleon\Parameters\CompanyUpdateParam\TechnicalData;
 ...
 * }
 */
final class CompanyUpdateParam implements BaseModel
{
    use Model;
    use Params;
