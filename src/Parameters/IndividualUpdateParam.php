...
use Dataleon\Parameters\IndividualUpdateParam\Person;
use Dataleon\Parameters\IndividualUpdateParam\TechnicalData;
 ...
 * }
 */
final class IndividualUpdateParam implements BaseModel
{
    use Model;
    use Params;
