...
>
> **We'd love your feedback!** Please share any suggestions, bug reports, feature requests, or general thoughts by [filing an issue](https://www.github.com/stainless-sdks/dataleon-php/issues/new).
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "git@github.com:stainless-sdks/dataleon-php.git"
    }
  ],
  "require": {
    "dataleon/dataleon": "dev-main"
  }
}
```
...
See [the contributing documentation](https://github.com/stainless-sdks/dataleon-php/tree/main/CONTRIBUTING.md).
